Refer to [[State]]. Keep in mind that state is the root of all evil so we should have as little as possible. Favour static classes/static functions over creating instances of either.
